...
const DeleteModal = ({ title = "item", loading, onClose, onConfirm }) => {
  return (
    <Modal>
      <div
        id="popup-modal"
          ...
          <div className="relative bg-white rounded-lg  ">
            ...
            <div className="px-6 pb-6 text-center">
              ...
              <div className="flex items-center justify-between space-x-2 pt-3 border-t">
                <button
                  className={`px-4  font-medium text-white bg-red-500 border border-transparent rounded-md shadow-sm hover:bg-opacity-90 transition-all focus:outline-none w-full ${
